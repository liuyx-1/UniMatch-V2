...
Usage:
    python tools/build_siglip_manifest.py \\
        ...
        --data-roots endoscapes_seg50=/data/test/endoscapes_seg50_processed \\
                     cholecseg8k=/data/test \\
                     endovis2018=/data/test/endovis2018_processed \\
                     endovis2017_parts=/data/test/endovis2017_parts_processed \\
                     endovis2017_type=/data/test/endovis2017_type_processed \\
        --rate 0.10 --seed 42 \\
...
def main():
    ...
    ap.add_argument('--splits-root', type=Path, required=True,
                    help='e.g. /data/splits (contains unimatch_splits_*_<rate>_seed<seed>/)')
