...
Usage (AutoDL paths):
    python tools/vis_stage1.py \\
        --ckpt     /root/autodl-tmp/data/autonomous_surgery/siglip_train/affinity_per_ds/endovis2018/affinity_endovis2018.pt \\
        --manifest /root/autodl-tmp/data/autonomous_surgery/siglip_train/merged_val/manifest_endovis2018_val.jsonl \\
        --out-dir  /root/autodl-tmp/data/autonomous_surgery/siglip_train/affinity_per_ds/endovis2018/vis_stage1 \\
...
def main():
    ...
    if 'threshold' in ckpt and ckpt['threshold'] is not None:
        m.pooling.theta.data.copy_(ckpt['threshold'].float())
