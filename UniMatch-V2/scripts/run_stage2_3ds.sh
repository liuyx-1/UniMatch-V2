...
#   VARIANTS=  default "affinity"  (others: base / boundary / full / affinity_min / affinity)
...
export EXP_ARCHIVE=${EXP_ARCHIVE:-/root/autodl-tmp/exp_archive}
...
export DINOV2_VITB14_PATH=${DINOV2_VITB14_PATH:-/root/autodl-tmp/code/UniMatch-V2/pretrained/dinov2_vitb14_pretrain.pth}
...
BS=${BS:-2}
LR=${LR:-5e-6}
AFFINITY_DIR=${AFFINITY_DIR:-/root/autodl-tmp/data/autonomous_surgery/siglip_train/affinity_per_ds}
STAGE2_LOG_DIR=${STAGE2_LOG_DIR:-/root/autodl-tmp/exp_archive/_stage2_logs}
